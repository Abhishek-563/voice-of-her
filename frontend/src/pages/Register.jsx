      ...
      <div style={{
        ...
        <div style={{ maxWidth: "440px", paddingRight: "20px" }}>
          ...
          <p style={{
            ...
            Create an account to activate instant SOS support and track your safety in real-time.
          </p>
          ...
          <p style={{ textAlign: "center", color: "#94a3b8", fontSize: "0.9rem" }}>
            ...
            <Link to="/login" style={{ color: "#f472b6", fontWeight: 700, textDecoration: "none" }}>
              Login
            </Link>
          </p>
        </div>
